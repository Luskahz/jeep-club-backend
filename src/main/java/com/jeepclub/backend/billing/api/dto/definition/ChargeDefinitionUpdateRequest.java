...
@Schema(description = "Dados para atualização completa de uma definição de cobrança.")
public record ChargeDefinitionUpdateRequest(

        @NotBlank(message = "Nome da cobrança é obrigatório.")
        @Size(max = 120, message = "Nome da cobrança deve ter no máximo 120 caracteres.")
        @Schema(
                description = "Nome atualizado da cobrança.",
                example = "Anuidade",
        ...
        @Schema(
                description = "Descrição atualizada da cobrança.",
        ...
        @Schema(
                description = "Valor padrão atualizado da cobrança.",
                example = "250.00",
                requiredMode = Schema.RequiredMode.REQUIRED
        )
        ...
        @Schema(
                description = "Tipo de recorrência atualizado da cobrança.",
                example = "YEARLY",
