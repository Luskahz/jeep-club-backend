...
@Schema(description = "Dados para envio de comprovante de pagamento.")
public record SubmitMemberPaymentRequest(
        ...
        @Schema(description = "Arquivo PDF, JPEG, PNG ou WebP de até 10 MB.", type = "string", format = "binary", requiredMode = Schema.RequiredMode.REQUIRED)
        MultipartFile receiptFile,

        @Size(max = 500, message = "Observações devem ter no máximo 500 caracteres.")
        @Schema(description = "Observações do usuário sobre o pagamento.", example = "Pagamento realizado via Pix.", nullable = true)
        String notes
) {
}
