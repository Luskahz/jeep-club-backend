package com.jeepclub.backend.billing.core.application.service.chargecycle;
...
public class AdminChargeCycleService {
    ...
    public ChargeCycleResult cancel(
        ...
        adminMemberRefundService.createEligibilityForCanceledCycle(
                savedChargeCycle.getId(),
                canceledByUserId,
                now
        );
