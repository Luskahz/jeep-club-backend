...
/**
 * OpenAPI-only description of the direct Spring Data page returned to members.
 * The endpoint continues to return {@code Page<ToolSummaryResponseDTO>}.
 */
@Schema(
        name = "PageToolSummaryResponse",
        description = "Página Spring Data de ferramentas do membro, sem filtro implícito de status."
)
