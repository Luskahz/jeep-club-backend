 ...
 * The endpoint continues to return {@code Page<MembershipApplicationResponseDTO>}.
 */
@Schema(
        name = "PageMembershipApplicationResponseDTO",
        description = "Página Spring Data de solicitações de adesão."
)
public record MembershipApplicationPageResponseSchema(
        @Schema(description = "Quantidade total de elementos.", example = "42")
        long totalElements,
        @Schema(description = "Quantidade total de páginas.", example = "3")
        int totalPages,
        @Schema(description = "Tamanho solicitado da página.", example = "20")
        int size,
        @Schema(description = "Solicitações presentes na página.")
