package com.jeepclub.backend.authentication.api.controller.admin.session;

import com.jeepclub.backend.authentication.api.dto.admin.session.AdminSessionResponseDTO;
import com.jeepclub.backend.authentication.core.application.results.admin.session.AdminSessionResult;
import com.jeepclub.backend.authentication.core.application.services.admin.AdminSessionService;
...
@Validated
@Tag(
        name = "Authentication Admin - Sessions",
        description = "Rotas administrativas para consulta e encerramento de sessões."
)
