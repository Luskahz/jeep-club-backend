...
public class PasswordRecoveryRequestController {
    ...
    private final RequestPasswordRecoveryService requestPasswordRecoveryService;
    private final SendPasswordRecoveryEmailService sendPasswordRecoveryEmailService;
    private final ResetPasswordByTokenService resetPasswordByTokenService;
    ...
    public ResponseEntity<Void> resetPasswordByToken(
        ...
        resetPasswordByTokenService.reset(
                request.token(),
                request.newPassword()
        );
