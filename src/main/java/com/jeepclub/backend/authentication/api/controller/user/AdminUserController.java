package com.jeepclub.backend.authentication.api.controller.admin.user;

import com.jeepclub.backend.authentication.api.dto.admin.user.AdminUserResponseDTO;
import com.jeepclub.backend.authentication.core.application.results.admin.user.AdminUserResult;
import com.jeepclub.backend.authentication.core.application.services.admin.AdminUserService;
...
@Validated
@Tag(
        name = "Authentication Admin - Users",
        description = "Rotas administrativas para consulta e gerenciamento de usuários."
)
