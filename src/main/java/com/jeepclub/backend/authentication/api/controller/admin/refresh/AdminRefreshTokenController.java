package com.jeepclub.backend.authentication.api.controller.admin.refresh;

import com.jeepclub.backend.authentication.api.dto.admin.refresh.AdminRefreshTokenResponseDTO;
import com.jeepclub.backend.authentication.core.application.result.admin.refresh.AdminRefreshTokenResult;
import com.jeepclub.backend.authentication.core.application.service.admin.AdminRefreshTokenService;
...
@Validated
@Tag(
        name = "Authentication Admin - Refresh Tokens",
        description = "Rotas administrativas para consulta e revogação de refresh tokens."
)
