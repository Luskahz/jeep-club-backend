    ...
    void openApiDescribesMembershipContractsPrecisely() throws Exception {
        mockMvc.perform(get("/v3/api-docs"))
                ...
                .andExpect(jsonPath("$['paths']['/admin/membership-applications']['get']['responses']['200']['content']['application/json']['schema']['$ref']")
                        .value("#/components/schemas/PageResponseMembershipApplicationResponseDTO"))
                .andExpect(jsonPath("$['paths']['/admin/membership-applications/{id}']['get']['responses']['404']['content']['application/problem+json']['schema']['$ref']")
                        .value("#/components/schemas/ApiErrorResponse"))
                .andExpect(jsonPath("$['components']['schemas']['PageResponseMembershipApplicationResponseDTO']['properties']['content']['type']")
                        .value("array"))
                .andExpect(jsonPath("$['components']['schemas']['PageResponseMembershipApplicationResponseDTO']['properties']['content']['items']['$ref']")
                        .value("#/components/schemas/MembershipApplicationResponseDTO"))
                .andExpect(jsonPath("$['components']['schemas']['PageResponseMembershipApplicationResponseDTO']['properties']['pageable']").doesNotExist())
