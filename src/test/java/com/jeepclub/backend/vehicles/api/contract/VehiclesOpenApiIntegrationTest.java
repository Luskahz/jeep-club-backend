    ...
    void openApiDescribesMemberAndAdministrativeVehicleContracts() throws Exception {
        mockMvc.perform(get("/v3/api-docs"))
                ...
                .andExpect(jsonPath("$['paths']['/vehicles/list/member']['get']['responses']['200']['content']['application/json']['schema']['$ref']")
                        .value("#/components/schemas/PageVehicleListResponse"))
                ...
                .andExpect(jsonPath("$['components']['schemas']['PageVehicleListResponse']['properties']['content']['type']")
                        .value("array"))
                .andExpect(jsonPath("$['components']['schemas']['PageVehicleListResponse']['properties']['content']['items']['$ref']")
                        .value("#/components/schemas/ListResponseDTO"))
                .andExpect(jsonPath("$['components']['schemas']['EditRequestDTO']['description']")
                        .value(org.hamcrest.Matchers.containsString("não possui semântica parcial")))
                .andExpect(jsonPath("$['components']['schemas']['EditRequestDTO']['required']")
                        .value(hasItems("manufacturingYear", "modelYear", "seatingCapacity", "engineDisplacement", "towing")))
                .andExpect(jsonPath("$['components']['schemas']['EditRequestDTO']['properties']['engineDisplacement']['description']")
                        .value(org.hamcrest.Matchers.containsString("deve estar presente")))
