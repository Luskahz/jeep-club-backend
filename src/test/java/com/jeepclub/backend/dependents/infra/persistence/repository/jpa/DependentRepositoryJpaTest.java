package com.jeepclub.backend.dependents.infra.persistence.repository.jpa;
...
@DataJpaTest
@ActiveProfiles("test")
@Import({DependentRepositoryJpa.class, DependentMapper.class})
class DependentRepositoryJpaTest {

    private static final Instant NOW = Instant.parse("2026-06-30T12:00:00Z");

    @Autowired
    private DependentRepositoryJpa repository;
    @Autowired
