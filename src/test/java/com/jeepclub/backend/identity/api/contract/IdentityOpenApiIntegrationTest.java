    ...
    void openApiDescribesIdentityContractsPrecisely() throws Exception {
        mockMvc.perform(get("/v3/api-docs"))
                ...
                .andExpect(jsonPath("$['paths']['/identity/admin/users']['get']['responses']['200']['content']['application/json']['schema']['$ref']")
                        .value("#/components/schemas/PageResponseAdminUserResponse"))
                .andExpect(jsonPath("$['components']['schemas']['PageResponseAdminUserResponse']['properties']['content']['type']")
                        .value("array"))
                .andExpect(jsonPath("$['components']['schemas']['PageResponseAdminUserResponse']['properties']['content']['items']['$ref']")
                        .value("#/components/schemas/AdminUserResponse"))
                .andExpect(jsonPath("$['components']['schemas']['PageResponseAdminUserResponse']['properties']['totalElements']['format']")
                        .value("int64"))
                .andExpect(jsonPath("$['components']['schemas']['PageResponseAdminUserResponse']['properties']['number']['format']")
                        .value("int32"))
                .andExpect(jsonPath("$['components']['schemas']['PageResponseAdminUserResponse']['properties']['pageable']").doesNotExist())
                .andExpect(jsonPath("$['components']['schemas']['PageResponseAdminUserResponse']['properties']['sort']").doesNotExist())
                ...
                .andExpect(jsonPath("$['paths']['/identity/admin/users/{userId}/enable']['patch']['responses']['400']['content']['application/problem+json']['schema']['$ref']")
                        .value("#/components/schemas/ApiErrorResponse"))
                .andExpect(jsonPath("$['paths']['/identity/admin/users/{userId}/enable']['patch']['responses']['409']['content']['application/problem+json']['schema']['$ref']")
                        .value("#/components/schemas/ApiErrorResponse"))
                .andExpect(jsonPath("$['paths']['/identity/admin/users/{userId}/enable']['patch']['responses']['409']['content']['application/json']")
                        .doesNotExist());
    }
