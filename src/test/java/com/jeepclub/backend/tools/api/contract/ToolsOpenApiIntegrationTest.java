    ...
    void openApiDescribesCurrentMemberAndAdministrativeToolContracts() throws Exception {
        mockMvc.perform(get("/v3/api-docs"))
                ...
                .andExpect(jsonPath("$['paths']['/tools']['get']['responses']['200']['content']['application/json']['schema']['$ref']")
                        .value("#/components/schemas/PageToolSummaryResponse"))
                ...
                .andExpect(jsonPath("$['paths']['/admin/tools']['get']['responses']['200']['content']['application/json']['schema']['$ref']")
                        .value("#/components/schemas/PageAdminToolSummaryResponse"))
                ...
                .andExpect(jsonPath("$['components']['schemas']['PageToolSummaryResponse']['properties']['content']['type']")
                        .value("array"))
                .andExpect(jsonPath("$['components']['schemas']['PageToolSummaryResponse']['properties']['content']['items']['$ref']")
                        .value("#/components/schemas/ToolSummaryResponseDTO"))
                .andExpect(jsonPath("$['components']['schemas']['PageAdminToolSummaryResponse']['properties']['content']['items']['$ref']")
